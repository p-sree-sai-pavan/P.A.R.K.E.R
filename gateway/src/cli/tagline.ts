const DEFAULT_TAGLINE = "All your chats, one Parker.";
...
const TAGLINES: string[] = [
  "Your terminal has been upgraded with automated protocols, sir.",
  ...
  "Automation with precision, sir: minimal fuss, maximal efficiency.",
  ...
  "Commit in, ship out—let's keep the codebase stable and reliable.",
  "I'll butter your workflow like a hot scone: clean, satisfying, and effective.",
  "Shell yeah—I'm here to pinch the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only AI butler in your contacts, sir.",
  ...
  "Built for productivity, refined by Parker.",
  ...
  "Half butler, half debugger, full assistant.",
  ...
  "You had me at 'parker gateway start.'",
